...
function AddCredits() {
    ...
    return (
        <div className='mt-20 mb-20 ml-6'>
            <div className='grid grid-cols-3 gap-x-2 gap-y-16'>
                <div className='relative max-w-[333px] max-h-[446px] bg-white rounded-2xl shadow-xl'>
                    {
                    ...
                    <div className='absolute top-[-25px] z-30 left-24 bg-primary px-5 py-3 rounded-2xl shadow-xl'>
                        <h1>Light Usage</h1>
                    </div>
                </div>

                <div className='relative max-w-[333px] max-h-[446px] bg-white rounded-2xl'>
                    {
                ...
                <div className='relative max-w-[333px] min-h-[356px] bg-white rounded-2xl col-span-6 justify-self-center pt-4 pb-10'>
                    {
                    ...
                    <div className='absolute top-[-25px] z-30 left-24 bg-[#AD44FF] px-5 py-3 rounded-2xl'>
                        <h1>Light Usage</h1>
                    </div>
                </div>
